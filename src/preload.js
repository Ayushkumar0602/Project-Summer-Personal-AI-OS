...
contextBridge.exposeInMainWorld('liveAPI', {
    ...
    registerBrowserTab: (payload) => ipcRenderer.send('browser-register-tab', payload),
    setActiveBrowserTab: (tabId) => ipcRenderer.send('browser-set-active-tab', tabId),
    unregisterBrowserTab: (tabId) => ipcRenderer.send('browser-unregister-tab', tabId),
    onBrowserUiHint: (callback) => ipcRenderer.on('browser-ui-hint', (event, hint) => callback(hint)),
